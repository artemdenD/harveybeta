...
public class ModuleManager implements IManager {
    ...
    public static TridentBowAim tridentBowAim = new TridentBowAim();
    public static AutoSwap autoSwap = new AutoSwap();
    public static JetBow jetBow = new JetBow();
    public static LegitStrafe legitStrafe = new LegitStrafe();
    public static FireworkExtend fireworkExtend = new FireworkExtend();
    public static KTLeave ktLeave = new KTLeave();
    ...
    public static ElytraJump elytraJump = new ElytraJump();
    public static DurabilityAlert durabilityAlert = new DurabilityAlert();
    public static FuntimeLadder funtimeLadder = new FuntimeLadder();
    public static FastLadder fastLadder = new FastLadder();
    public static Backtrack backtrack = new Backtrack();
    public static PostCriticals postCriticals = new PostCriticals();
